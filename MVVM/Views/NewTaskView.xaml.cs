...
using TASKER_APP.MVVM.ViewModels;

namespace TASKER_APP.MVVM.Views;
...
public partial class NewTaskView : ContentPage
{
    ...
    private async void AddCategoryClicked(object sender, EventArgs e)
    {
        var vm = BindingContext as NewTaskViewModel;
        string category =
            await DisplayPromptAsync("New Category", "Put the new category name", maxLength: 15, keyboard: Keyboard.Text);
